...
const SignUp = () => {
  ...
  const { registerUser, user, error, loading } = useAuthStore();
  ...
  const handleSubmit = async (e) => {
    ...
    if (Object.keys(validate(formData)).length === 0) {
      await registerUser(formData);   // ✅ call zustand action directly
      ...
      <div className="w-[50%] mx-auto pt-20">
        <div className="shadow-2xl w-[50%] mx-auto px-10 py-3 flex-col border rounded-xl bg-[#141515] border-zinc-700">
          <div className="flex justify-center items-center flex-col mx-auto text-zinc-200">
            ...
            <p className="text-sm">Join us and start budgeting smarter</p>
          </div>
          ...
          >
            {/* Name */}
            <div>
              <label htmlFor="name" className="text-md text-zinc-200">
                Name
              </label>
              <input
                type="text"
            ...
            {/* Email */}
            <div>
              <label htmlFor="email" className="text-md text-zinc-200">
                Email
              </label>
              <input
                type="email"
            ...
            {/* Password */}
            <div>
              <label htmlFor="password" className="text-md text-zinc-200">
                Password
              </label>
              <div className="flex justify-center items-center">
                ...
                >
                  <div className="border border-zinc-700 p-1 w-[35px] h-[35px] rounded-md flex justify-center items-center">
                    <img
                      src={visibility === "password" ? eye : closed_eye}
